...
@section('content_body')
    ...
    <div class="container">
        ...
        <div class="row my-4">
            ...
            @if(\Illuminate\Support\Facades\Auth::user()->rol == "Estudiante" &&$bitacora->estado == 'Finalizada')

                <div class="col-12 col-sm-10 col-lg-6 mx-auto my-3">
                    @if($bitacora->causa_renuncia == 'Aprobación del término de trabajo')
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <form action="{{ route('bitacoras-remover', $bitacora) }}" method="POST"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <br>
                                                    <span class="ml-4">
                                                <input class="form-check-input" type="checkbox" value="Finalizada"
                                                       name="estado"
                                                ...
                                                <div>
                                                    <button class="btn btn-lg btn-outline-danger btn-block rounded-pill"
                                                            id="btnRenuncia" disabled="disabled" data-toggle="modal"
                                                            data-target="#finalizarBitacora" type="submit">
                                                        Finalizar
                                                    </button>
                                                </div>
