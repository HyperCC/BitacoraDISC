...
<div class="container">
    ...
    <div class="row my-4">
                ...
                <div class="col-12 col-lg-6 mb-3">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            @if( \Illuminate\Support\Facades\Auth::user()->rol=='Secretaria' or  \Illuminate\Support\Facades\Auth::user()->rol== 'Encargado Titulación')
                            ...
                            <div>
                                ...
                                <div class="card px-3">
                                    ...
                                    <div class="input-group my-3">
                                        ...
                                        <p class="form-control" aria-describedby="basic-addon3"> {{ $bitacora->causa_renuncia }} </p>
                                    </div>
                                </div>
                                ...
                                <div class="mt-3">
                                    ...
                                    <form action="{{ route('bitacoras-remover', $bitacora) }}" method="POST" class="form-group" name="formEnding" onsubmit="comprobar()">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                            <span class="ml-4">
                                                <input class="form-check-input" type="checkbox" value="Finalizada" name="estado" onClick="habilitaDeshabilita(this.form)"> Si </span>
                                        </div>
                                        ...
                                        <div class="form-group ml-4">
                                            ...
                                            <input disabled checked class="form-check-input" type="radio" name="causaRenuncia" value="No continuidad del trabajo">
                                            <label class="form-check-label">No continuidad del trabajo</label>
                                            <br>

                                            <input disabled class="form-check-input" type="radio" name="causaRenuncia" value="Aprobación del término de trabajo">
                                        ...
                                        <div>
                                            <button class="btn btn-lg btn-outline-danger btn-block rounded-pill" id="btnRenuncia" disabled="disabled" data-toggle="modal" data-target="#finalizarBitacora" type="submit">
                                                Finalizar
                                            </button>
                                        </div>
                            ...
                            <div>
                                <a class="btn btn-lg btn-outline-warning btn-block rounded-pill mb-2 text-dark" href="{{ route('bitacoras-edit', $bitacora) }}">
                                    Editar
                                </a>
                            </div>
        ...
        @elseif($bitacora->estado == 'Finalizada' && $bitacora->causa_renuncia == 'Aprobación del término de trabajo')
