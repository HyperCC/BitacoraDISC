                ...
                <div class="bg-white py-3 px-4 shadow rounded">
                    ...
                    <form method="POST" action="{{ route('bitacoras-update', $bitacora) }}">
                        ...
                        <div class="form-group">
                            <label class="custom-select-lg ml-1" for="name"><h5>Titulo</h5></label>
                        ...
                        @if($bitacora->estado=="Finalizada")
                            ...
                            <input class="form-check-input" type="checkbox" name="estado"
                                   value="Activa"> Si</span>
                            </div>
                        @endif

                        <div class="py-3">
                            <button class="btn btn-primary btn-lg btn-block rounded-pill" type="submit">
                                Guardar Titulo @if($bitacora->estado=="Finalizada")- Estado @endif
                            </button>
                        </div>
                    ...
                    <form method="POST" action="{{ route('bitacoras-store-profesor') }}">
                        ...
                        <div class="form-group">
                            <label for="id_estudiante1"><h5>Profesores disponibles para agregar:</h5></label>
                            <select class="form-control selectalumnos" name="id_profe"
                                    @if($bitaProfes>1) disabled @endif>
