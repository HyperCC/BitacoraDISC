                ...
                @extends('helpers.validate_errors')
                    ...
                    <form class="bg-white py-3 px-4 shadow rounded" method="POST" action="{{ route('comentario-store') }}"
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control shadow-sm bg-light" name="nombre" type="text" required>
                        </div>
                        
                        <div class="form-group">
                            <label for="comentario"> Texto del comentario </label>
                            <textarea type = "text" class="form-control shadow-sm bg-light" required autocomplete="off" name="comentario" style = "height: 200px"> </textarea>
                        </div>
